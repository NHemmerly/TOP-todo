...
export function renderProjectForm() {
    ...
    const formProject = domElement('div', {class: 'px-6 py-6 lg:px-8'},
        ...
        domElement('form', {class: 'space-y-6', action: '#'},
            ...
            domElement('button', {id: 'createNewProject',type:'submit', class: 'w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center'}, 'Create New Project')));
