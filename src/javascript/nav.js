...
export function renderNav(){
    const nav = domElement('nav', {class: 'p-3 m-3 mx-4 border-yellow-400 rounded bg-yellow-400 dark:bg-yellow-700 dark:border-yellow-700'},
        domElement('div', {class: 'container flex flex-wrap items-center justify-between mx-auto'},
            domElement('span', {class: 'self-center text-2xl font-semibold whitespace-nowrap text-white'}, 'Dayly'),
